#### My approach to this kata

* Got the first failing test to pass
* Decided to look at the specification and write tests for each one, to make sure that they are all passing.
* There were issues with the maximum and minimum quality so added rescue clauses in for those.
* Some of the backstage passes logic didn't work so fixed it per the tests.
* Refactored original code to include a case statement for each of the named items in the spec.
